const UTILS = {
    getPoolTokenIds: async (
        ...
        const liquidityAddedEvents = await walletClient.getEventStream(
            poolAddress,
            eventStore,
        ...
        const liquidityRemovedEvents = await walletClient.getEventStream(
            poolAddress,
            eventStore,
        ...
        const swapCoinToTokensEvents = await walletClient.getEventStream(
            poolAddress,
            eventStore,
            "swap_coin_to_tokens_handle",
            limit,
            start
        );

        const swapTokensToCoinEvents = await walletClient.getEventStream(
            poolAddress,
            eventStore,
            "swap_tokens_to_coin_handle",
            limit,
            start
        );

        const claimTokensEvents = await walletClient.getEventStream(
            poolAddress,
            eventStore,
            "claim_tokens_handle",
            limit,
