...
import { MaybeHexString, Types as Gen, FaucetClient, AptosClient, TokenClient, AptosAccount, HexString, BCS, TxnBuilderTypes, OptionalTransactionArgs } from "aptos";
export declare const MAX_U64_BIG_INT: bigint;
...
export declare class WalletClient {
     ...
     */
    getSentEvents(address: MaybeHexString, limit?: number, start?: BCS.AnyNumber): Promise<Gen.Transaction[]>;
    /**
     ...
     * @returns list of events
     */
    getReceivedEvents(address: string, limit?: number, start?: BCS.AnyNumber): Promise<{
        guid: {
     ...
     * @returns transaction hash
     */
    createCollection(account: AptosAccount, name: string, description: string, uri: string, maxAmount?: BCS.AnyNumber, extraArgs?: OptionalTransactionArgs): Promise<string>;
    /**
     * creates an NFT
     *
     * @param account AptosAccount object of the signing account
    ...
    estimateGasFees(account: AptosAccount, transaction: TxnBuilderTypes.RawTransaction): Promise<string>;
    estimateCost(account: AptosAccount, transaction: TxnBuilderTypes.RawTransaction): Promise<string>;
    ...
    static generateBCSTransaction(account: AptosAccount, rawTxn: TxnBuilderTypes.RawTransaction): Promise<Uint8Array>;
    static generateBCSSimulation(account: AptosAccount, rawTxn: TxnBuilderTypes.RawTransaction): Promise<Uint8Array>;
    ...
    getTokensFromTokenIds(tokenIds: any[]): Promise<any[]>;
    getTokensFromTokenIdsWithCount(tokenIdObjects: any[]): Promise<any[]>;
    /**
